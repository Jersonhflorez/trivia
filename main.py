...
iniciar_trivia = True
intentos = 0
print(GREEN+"HOLA AMIG@S DE MTPE"+RESET)

time.sleep(2)
print("\033[32m Hoy pondremos a prueba mi trivia y de cuanto has aprendido del curso de Back End \n\033[39m")
time.sleep(2)
print("\033[34mComenzarás con:\033[39m",puntaje,"puntos")
time.sleep(2)
nombre=input("\033[34mEscribe tu nombre:\033[39m")

print("\033[34m\nMuy bien\033[39m",nombre,"\033[34m¿Estas Listo?\033[39m\n")
time.sleep(2)
...
while iniciar_trivia == True: 
   ...
   print("\n\033[33m1)¿Que es Python .py ? \033[39m\n")
   
   alternativa = ["a)Un animal","b)Una Maquina de fundicion","c)Un lenguaje de programacion","d)Un Interprete de algoritmos binarios"]
